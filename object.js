...
console.log(reviews.find((review) => review.name === "Julius"));
/* Task 4: Add a new rating with your (fictitious) opinions of the restaurant in the same format as the reviews above. */
reviews.push({ name: "elbeg", rating: 10, feedback: "excellent" });
console.log(reviews);
/* Task 5: change the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"*/
reviews.find((review) => review.name === "Reyna").rating =
...
function getReviewByIndex(arr, index) {
  const chooseReview = arr[index];
  return `${chooseReview.name} gave the restaurant ${chooseReview.rating} star review and their feedback was: ${chooseReview.feedback}`;
}
...
function getLastReview(array) {
  ...
  return `${lastReview.name} gave the restaurant ${lastReview.rating} star review and their feedback was: ${lastReview.feedback}`;
}
